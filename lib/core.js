...
function generate(opts) {
    ...
    return Bluebird.map(opts.dimensions, function (dimensions) {
        ...
        if(opts.dest.endsWith('phtml')){
            ...
            criticalCSS = criticalCSS.replace(search, replacement);
            criticalCSS = criticalCSS.replace(searchApostrophe, replacementApostrophe);
            criticalCSS = criticalCSS.replace(searchQuote, replacementQuote);
        }
